...
#db_name = "PXLTD_THANX_DEV"
#table_name = "RCGNTN_MSG_SLACK"

SLACK_TOKEN = sys.argv[4]
SLACK_CHANNEL_ID = sys.argv[5]
#SLACK_TOKEN = "xoxp-152818971696-530149612055-530690017942-04c2a7bb6a4f9bb9d0506518e055e7b8" #DEV
#SLACK_CHANNEL_ID = "CFK1NB6TC"
...
channel_history = sc.api_call("channels.history", channel = SLACK_CHANNEL_ID, count = 1000, inclusive = False, oldest = float(lastTimestamp)+.000001)
...
channel_history = sc.api_call("channels.history", channel = SLACK_CHANNEL_ID, count = 1000, inclusive = True, oldest = timestampPrev)
if "messages" in channel_history:
	for each_msg in channel_history["messages"]:
